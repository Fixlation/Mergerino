...
constexpr bool mergedPlatformIndicatorShowsBadge(
    PlatformIndicatorMode value) noexcept
{
    return value == PlatformIndicatorMode::Badge ||
           value == PlatformIndicatorMode::Both;
}

constexpr bool mergedPlatformIndicatorShowsLineColor(
    PlatformIndicatorMode value) noexcept
{
    return value == PlatformIndicatorMode::LineColor ||
           value == PlatformIndicatorMode::Both;
}

enum class PlatformEventHighlightStyle : std::uint8_t {
    Gradient,
    None,
    PlatformColor,
    CustomColor,
...
constexpr std::optional<std::string_view> qmagicenumDisplayName(
    PlatformEventHighlightStyle value) noexcept
{
    switch (value)
    {
        case PlatformEventHighlightStyle::Gradient:
            return "Gradient (default)";
        case PlatformEventHighlightStyle::None:
            return "None";
        case PlatformEventHighlightStyle::PlatformColor:
            return "Platform color";
        case PlatformEventHighlightStyle::CustomColor:
            return "Custom color";
    }
}
...
public:
    ...
    QStringSetting platformEventHighlightCustomColor = {
    ...
    BoolSetting startupPromptAcknowledged = {
        "/behaviour/startupPromptAcknowledged",
        false,
    };
