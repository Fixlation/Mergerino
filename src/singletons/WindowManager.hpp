...
public:
    ...
    ProviderId activeAccountProvider() const;
    void setActiveAccountProvider(ProviderId provider);
    ...
    void reloadChannelViews(Channel *channel = nullptr);
    ...
    // the channel is a nullptr, need to rebuild message-derived caches such as
    // scrollbar highlights.
    pajlada::Signals::Signal<Channel *> reloadMessagesRequested;
...
private:
    ...
    ProviderId activeAccountProvider_{ProviderId::Twitch};
    ...
    SignalListener reloadChannelViewsListener;
