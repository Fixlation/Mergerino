...
void ExternalToolsPage::initLayout(GeneralPageView &layout)
{
...

    {
        ...
        layout.addDescription(
            QStringLiteral(
                "Mergerino expects the executable to be called \"%1\".")
...
#ifdef CHATTERINO_WITH_SPELLCHECK
    {
        ...
        layout.addDescription(
            ...
            " Mergerino does not include dictionaries - they have to "
            "be downloaded or created manually. Mergerino expects "
            "Hunspell "
            "dictionaries in " %
